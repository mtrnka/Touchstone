...
```{r search_compare_params, results='hide', message=FALSE, warning=FALSE}
...
```{r scaling_factor, message=FALSE, warning=FALSE}
...
```{r assign_fractions, message=FALSE, warning=FALSE}
